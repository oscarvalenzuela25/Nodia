...
## Regla Global
- Cada proyecto en el que vaya a trabajar, primero debo de revisar el AGENTS.md para ver las directrices o como tiene definido su forma de trabajar antes de hacer algun cambio, si dentro del AGENTS dice que tengo que utilizar skills, las utilizare sin resistirme.

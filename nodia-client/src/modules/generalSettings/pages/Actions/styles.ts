...
export const BusinessSectionCard = styled(Paper)(({ theme }) => {
  const borderColor = theme.palette.border?.default ?? theme.palette.divider;
  const isDark = theme.palette.mode === "dark";
...
export const BusinessSectionHeader = styled(Box)(({ theme }) => ({
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
...
export const BusinessHeaderInfo = styled(Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(1.5),
}));

export const BusinessHeaderActions = styled(Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(1.5),
  flexWrap: "wrap",
